    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-24">
      ...
      >
        <motion.div variants={itemVariants} className="mb-6">
          <motion.div
            className="inline-block px-4 py-2 rounded-full border border-violet-500/30 bg-violet-500/10"
        ...
        >
          ...
          <motion.span
            className="block bg-gradient-to-r from-violet-400 via-cyan-400 to-pink-400 bg-clip-text text-transparent"
            animate={{
        ...
        <motion.div variants={itemVariants} className="flex gap-4 justify-center mb-20">
          <Link href="/work">
            <motion.button
          ...
          {categories.map((category) => (
            <Link key={category.title} href={category.href}>
              ...
              >
                ...
                <category.icon
                  size={40}
                  className={`mb-4 bg-gradient-to-br ${category.color} bg-clip-text text-transparent`}
                />
